...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Capivara", "Javali", "Girafa", "Hipopotamo", "Galinha", "Pomba"];
  string[] secondWords = ["Pizza", "Vatapa", "Acaraje", "Churrasco", "Chocolate", "Bombom"];
  string[] thirdWords = ["Carro", "Onibus", "Lancha", "Moto", "Jetski", "Yati"];
